...
Version: 0.1.6 Lite (remains a BETA version on which I work)
...
def run_selected_scanners():
    ...
    for scanner_info in scanner_vars:
        ...
        if scanner_var.get():
            ...
            scanner_infos.append((scanner_instance.libsane_name, scanner_instance.nickname, resolution, image_name, width, height, left, top, format_image, save_directory))
