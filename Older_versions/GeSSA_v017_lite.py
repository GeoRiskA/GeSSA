...
scanner_model = "Epson Expression 12000XL"  # Name of the scanner model
vendor_ID = '0x04b8'
product_ID = '0x015b'
...
x = 245  # Width of scan-area (in mm).
y = 245  # Height of scan-area (in mm).
...
used_theme = "/home/user/Desktop/GeSSA/ttk_Theme/sun-valley.tcl"  # Available here: https://github.com/rdbende/Sun-Valley-ttk-theme
...
def scan(scanner_name, scanner_nickname, resolution, image_name, width, height, left, top, format_image,
         save_directory):
...
def run_selected_scanners():
    ...
    for scanner_info in scanner_vars:
        scanner_var, scanner_instance, resolution_var, image_name_var, width_var, height_var, left_var, top_var = scanner_info
        ...
        if scanner_var.get():
            ...
            scanner_infos.append((scanner_instance.libsane_name, scanner_instance.nickname, resolution, image_name,
                                  width, height, left, top, format_image, save_directory))
    ...
    for scanner_info in scanner_vars:
        ...
        if scanner_var.get():
            ...
            scanner_infos.append((scanner_instance.libsane_name, scanner_instance.nickname, preview_image_name, width,
                                  height, left, top, preview_folder))
...
for scanner_instance in scanner_instances:
    ...
    scanner_vars.append(
        (scanner_var, scanner_instance, resolution_var, image_name_var, width_var, height_var, left_var, top_var))
