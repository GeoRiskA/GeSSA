...
Version: 0.1.5 (remains a BETA version on which I work)
...
-[X] Add the possibility to select paper photo and slide (transparency)
...
-[X] Debugging the resolution selection when SCAN is pressed
...
COPYRIGHTING = "(c) Royal Museum for Central Africa / Vrije Universiteit Brussel, 2023"
...
def run_selected_scanners():
    ...
    for scanner_info in scanner_vars:
        ...
        if scanner_var.get():
            ...
            scanner_infos.append((scanner_instance.libsane_name, scanner_instance.nickname, scantype, resolution, unique_image_name, width, height, left, top, format_image, save_directory))
